...
export default function CrashReportNotice() {
  ...
  return (
    <div
      role="status"
      className="mx-3 md:mx-6 mt-4 mb-2 bg-warn/10 border border-warn/30 rounded-lg p-3 md:p-4 flex flex-wrap md:flex-nowrap items-start gap-3 animate-rise"
    >
      ...
      <Btn
        onClick={() => { void crashReportsAPI()?.reveal().catch(() => {}) }}
