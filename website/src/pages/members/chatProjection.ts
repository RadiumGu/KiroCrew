 ...
 *   are always kept; `streaming` is kept only on the trailing turn while the
 *   session runs.
 */
...
const ALWAYS_KEPT_ROLES: readonly string[] = Object.freeze(['user', 'escalation', 'permission', 'mcp_oauth', 'error'])
