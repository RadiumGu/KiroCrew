    ...
    return [
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "evidence_scope": {
                        "type": "string",
                        "enum": ["provider_facts_and_comments"],
                        "description": (
                            "Set only when comments or advisory findings are required. Such "
                            "watches are refused and must use a finite monitor_start loop"
                        ),
                    },
                    "interval_secs": {
                        "type": "integer",
        ...
        },
        {
            ...
            "description": (
                ...
                "Discord, use monitor_update to revise or re-arm a stale "
                "instruction. On Webex, stop the loop and create a new finite "
                "one instead. One automation may occupy a session; monitor_start "
...
def monitor_watch(name: str, args: dict[str, Any]) -> str:
    ...
    if args.get("evidence_scope") == "provider_facts_and_comments":
        return _monitor_context_refusal(
            ...
            error="unsupported_evidence_scope",
        )
