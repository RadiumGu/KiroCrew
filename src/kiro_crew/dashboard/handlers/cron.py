...
async def api_cron_secret_grant(request: web.Request) -> web.Response:
    ...
    if body.get("deny_pending") is True:
        ...
        try:
            ...
            logger.warning("SEL unavailable; refusing secret denial for %s", job_id, exc_info=True)
    ...
    try:
        ...
        logger.warning("SEL unavailable; refusing secret revoke for %s", job_id, exc_info=True)
